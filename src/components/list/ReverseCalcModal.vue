    ...
    <div class="modal-box max-w-sm">
      ...
      <div class="space-y-3">
        <div class="form-control">
          <label class="label py-1"><span class="label-text font-semibold">售价</span>
        ...
        <div class="form-control">
          <label class="label py-1"><span class="label-text font-semibold">净利润</span>
            <span class="label-text-alt">R$</span></label>
          <input
            v-model="calcProfit"
            class="input input-bordered input-sm"
        ...
        <div class="form-control">
          <label class="label py-1"><span class="label-text font-semibold">利润率</span>
      ...
      <div class="modal-action">
        ...
        <button class="btn btn-primary btn-sm" @click="applyCalc">
          应用售价到 SKU
        </button>
      </div>
    </div>
