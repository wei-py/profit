    ...
    <div class="modal-box w-11/12 max-w-4xl max-h-[90vh] overflow-y-auto">
      ...
      <div class="mb-4">
        <div class="flex items-center justify-between mb-2">
          ...
          <button class="btn btn-xs btn-primary" @click="openNewRule">
            ＋
          </button>
        </div>
      ...
      <div class="mb-4">
        <div class="flex items-center justify-between mb-2">
          ...
          <div class="flex gap-1 items-center">
            ...
            >
            <button class="btn btn-xs btn-primary" @click="openNewLookup">
              ＋ 新建表
            </button>
          </div>
        </div>
        <table v-if="allLookupNames.length" class="table table-xs">
          ...
          <tbody>
            <tr v-for="name in allLookupNames" :key="name">
              ...
              <td class="flex gap-1">
                <button class="btn btn-ghost btn-xs" @click="openLookup(name)">
                  📊 编辑
                </button>
